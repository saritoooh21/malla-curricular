const materiasPorSemestre = [
  ...
  },
  {
    ...
    materias: [
      ...
      { nombre: "Electiva CMD: Ingeniería sin fronteras", creditos: 3 },
  ...
  },
  {
    semestre: "X",
    materias: [
      { nombre: "Electiva CMD: Ingeniería de desarrollo regional", creditos: 2 },
      { nombre: "Electiva CP", creditos: 2 },
      { nombre: "Electiva CP", creditos: 2 },
      { nombre: "Electiva CPC", creditos: 3 },
...
materiasPorSemestre.forEach((sem) => {
  ...
  sem.materias.forEach(materia => {
    ...
    m.innerHTML = `
      ...
      <span class="creditos">Créditos: ${materia.creditos}</span>
    `;
